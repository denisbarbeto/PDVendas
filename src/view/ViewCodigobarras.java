...
public class ViewCodigobarras extends javax.swing.JFrame {
    ...
    public ViewCodigobarras() {
        ...
        java.awt.Image iconeTitulo = Toolkit.getDefaultToolkit().getImage(caminhoIcone);
...
//direcionado para um arquivo PDF.
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("C://BLVendasPdvMySQL//relatorios//codigo_barra.pdf"));
...
//  Barcode128 (128, 128_UCC, 128_RAW),  BarcodeEAN (EAN13, EAN8, UPCA, UPCE), EANSUP, etc
                ...
                codeEAN.setCode(pListaCodigos.get(i).toString());
            ...
            //abrir o arquivo
            File file = new File("C://BLVendasPdvMySQL//relatorios//codigo_barra.pdf");
            try {
