...
public class ViewPdv extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcbImprimirPDF.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jcbImprimirPDF.setForeground(new java.awt.Color(0, 102, 102));
        jcbImprimirPDF.setSelected(true);
        jcbImprimirPDF.setText("Enviar cupom para impressora");
