    ...
    private void incluirProduto() {
        ...
        if (tfQuantidade.getText().equals("")) {
            ...
            if (modelProdutos.getValorCusto() > valorUnitario) {
                int option = JOptionPane.showConfirmDialog(rootPane, "O valor de venda é menor que o valor de compra! Custo: R$" + modelProdutos.getValorCusto() + " Venda: R$" + valorUnitario + "\n"
                        + "Para finalizar essa venda você deve ter permissão de administrador ou inserir uma senha com está permissão!!");
