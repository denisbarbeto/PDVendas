...
public class ControllerProdutos {
    ...
    * return boolean
    */
    public boolean atualizarProdutosQuantidadeValorController(ModelProdutos pModelProdutos){
        return this.daoProdutos.atualizarProdutosQuantidadeValorDAO(pModelProdutos);
    }
